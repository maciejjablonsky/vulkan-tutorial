...
namespace lve
{
void LveCamera::set_orthographic_projection(
...
void LveCamera::set_perspective_projection(float fovy,
                                           float aspect,
                                           float near,
                                           float far)
{
...
void LveCamera::set_view_direction(glm::vec3 position,
                                   glm::vec3 direction,
                                   glm::vec3 up)
{
...
void LveCamera::set_view_target(glm::vec3 position,
                                glm::vec3 target,
                                glm::vec3 up)
{
...
void LveCamera::set_view_xyz(glm::vec3 position, glm::vec3 rotation)
{
